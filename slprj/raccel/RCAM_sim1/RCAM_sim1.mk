...
MODEL                = RCAM_sim1
MODULES              = RCAM_sim1.c RCAM_sim1_capi.c RCAM_sim1_data.c RCAM_sim1_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = RCAM_sim1.exe
MAKEFILE             = RCAM_sim1.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2023a
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2023a
START_DIR            = D:/TUDelft/Thesis/References/RCAM
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/RCAM_sim1 \
