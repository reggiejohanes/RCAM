...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . c10sww4qfc [ 0 ] ) , 0 , 0 ,
255 } , { ( char_T * ) ( & rtDW . h1abylwox0 [ 0 ] ) , 0 , 0 , 9 } , { (
char_T * ) ( & rtDW . hscbc0octt . LoggedData [ 0 ] ) , 11 , 0 , 59 } , { (
char_T * ) ( & rtDW . gtrkyqalzw ) , 10 , 0 , 3 } , { ( char_T * ) ( & rtDW .
m5ykicffnh ) , 2 , 0 , 4 } } ; static DataTypeTransitionTable rtBTransTable =
{ 5U , rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { {
( char_T * ) ( & rtP . Ib [ 0 ] ) , 0 , 0 , 135 } } ; static
